...
return [
    ...
    'inaturalist_import_page_size' => (int) env('INATURALIST_IMPORT_PAGE_SIZE', 50),
    'geocoding_autocomplete_url' => env('GEOCODING_AUTOCOMPLETE_URL', 'https://data.geopf.fr/geocodage/completion/'),
    ...
    'faune_france_max_pages' => (int) env('FAUNE_FRANCE_MAX_PAGES', 200),
